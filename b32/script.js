...
function qwqdraw3(statData) {
	...
	ctxos.drawImage(app.bgImage, -1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2500.5 - imgWidthAct/2, 208 - (imgHeightAct - 660)/2, imgWidthAct, imgHeightAct);
	ctxos.beginPath();
	ctxos.moveTo(-1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2143.8539007193578074, 208);
	ctxos.lineTo(-1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 3034, 208);
	ctxos.lineTo(-1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2858.3860992806421925, 868);
	ctxos.lineTo(-1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 1968.24, 868);
	ctxos.closePath();
	ctxos.globalCompositeOperation = "destination-in";
	ctxos.fill();
	ctxos.globalCompositeOperation = "source-over";
	ctxos.globalAlpha = 0.5;
	ctxos.drawImage(res["LevelOver1"], -1720 * tween.easeOutCubic(range(qwqEnd.second - 0.1)) + 2768, 160, 849, 424.5);
	ctxos.drawImage(res["LevelOver3"], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.9 - 0.25)) + 1944, 550, 950, 190);
	ctxos.drawImage(res["LevelOver3"], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 1900, 715, 950, 190);
	ctxos.globalAlpha = 1;
	ctxos.drawImage(res["LevelOver4"], -1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 1694, 137, 1616, 804);
	//歌名和等级
	ctxos.globalAlpha = 1;
	ctxos.restore();
	ctxos.setTransform(qwq0 / 120, 0, 0, qwq0 / 120, app.wlen - qwq0 * 8, app.hlen - qwq0 * 4.5); //?
	...
	ctxos.fillText(inputName.value || inputName.placeholder, -1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2028, 802);
	...
	ctxos.textAlign = "right";
	ctxos.fillText(levelText, -1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2830, 825);
	ctxos.textAlign = "left";
	//Rank图标
	ctxos.globalAlpha = range((qwqEnd.second - 1.3) * 3.75);
	const qwq2 = 293 + range((qwqEnd.second - 1.3) * 3.75) * 100;
	const qwq3 = 410 - range((qwqEnd.second - 1.3) * 1.5) * 164;
	...
	ctxos.fillText(statData.newBestStr, -1720 * tween.easeOutCubic(range(qwqEnd.second - 0.1)) + 2855, 485);
	ctxos.fillStyle = "#fff";
	ctxos.textAlign = "left";
	ctxos.fillText(statData.scoreBest, -1720 * tween.easeOutCubic(range(qwqEnd.second - 0.1)) + 3005, 485);
	// 	ctxos.globalAlpha = range((qwqEnd.second - 1.87) * 2.50);
	ctxos.textAlign = "left";
	ctxos.fillText(statData.scoreDelta, -1720 * tween.easeOutCubic(range(qwqEnd.second - 0.1)) + 3140, 485);
	ctxos.globalAlpha = range((qwqEnd.second - 0.8) * 1.50);
	ctxos.textAlign = "right";
	ctxos.font = "50px SyHybrid,Saira";
	ctxos.fillText(stat.accStr, -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.9 - 0.25)) + 2749, 635);
	ctxos.font = "26px SyHybrid,Saira,Noto Sans SC";
	ctxos.fillText("Accuracy", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.9 - 0.25)) + 2755, 670);
	ctxos.textAlign = "left";
	ctxos.font = "50px Saira,SyHybrid,Noto Sans SC";
	ctxos.fillText(stat.maxcombo, -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.9 - 0.25)) + 2100, 635);
	ctxos.font = "26px Saira,SyHybrid,Noto Sans SC";
	ctxos.fillText("Max Combo", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.9 - 0.25)) + 2095, 670);
	...
	ctxos.fillText(stat.scoreStr, -1720 * tween.easeOutCubic(range(qwqEnd.second - 0.1)) + 2845, 433);
	ctxos.textAlign = "right";
	ctxos.font = "25px Saira,SyHybrid,Noto Sans SC";
	ctxos.fillStyle = "#83e691";
	ctxos.fillText(app.speed === 1 ? '' : statData.textAboveStr.replace('{SPEED}', app.speed.toFixed(2)), -1920 * tween.easeOutCubic(range(qwqEnd.second * 1)) + 2830, 792);
	//Perfect, good, bad, miss
	ctxos.fillStyle = "#fff";
	ctxos.font = "43px Saira,SyHybrid,Noto Sans SC";
	ctxos.textAlign = "center";
	ctxos.globalAlpha = range((qwqEnd.second - 1.25) * 2.50);
	ctxos.fillText(stat.perfect, -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2085, 805);
	ctxos.fillText(stat.good, -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2233, 805);
	ctxos.fillText(stat.noteRank[6], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2340, 805);
	ctxos.fillText(stat.noteRank[2], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2447, 805);
	ctxos.font = "17px Saira,SyHybrid,Noto Sans SC";
	ctxos.fillText("Perfect", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2085, 834);
	ctxos.fillText("Good", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2233, 834);
	ctxos.fillText("Bad", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2340, 834);
	ctxos.fillText("Miss", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2447, 834);
	ctxos.font = "26px Saira,SyHybrid,Noto Sans SC";
	//Early, Late
	const qwq4 = range((qwq[3] > 0 ? qwqEnd.second - qwq[3] : 0.2 - qwqEnd.second - qwq[3]) * 5.00);
	ctxos.textAlign = "left";
	ctxos.fillText("Early", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2540, 800);
	ctxos.fillText("Late", -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2540, 826);
	ctxos.textAlign = "right";
	if (autoplay.checked) {
		ctxos.globalAlpha = range((qwqEnd.second - 1.25) * 2.50);
	} else {
	...
	ctxos.fillText(stat.noteRank[7], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2705, 800);
	ctxos.fillText(stat.noteRank[3], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2705, 826);
	ctxos.globalAlpha = 0;
	ctxos.fillStyle = '#696';
	...
	if (autoplay.checked) {} else {
		ctxos.fillText(stat.noteRank[5], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2705, 800);
		ctxos.fillText(stat.noteRank[1], -1020 * tween.easeOutCubic(range(qwqEnd.second * 0.8 - 0.3)) + 2705, 826);
	}
