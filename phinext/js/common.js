...
export const urls = {
	jszip: ['//fastly.jsdelivr.net/npm/jszip', '//cdn.jsdelivr.net/npm/jszip', '../js/jszip.js'],
	...
	blur: ['//fastly.jsdelivr.net/npm/stackblur-canvas', '//cdn.jsdelivr.net/npm/stackblur-canvas', './js/imgBlur.js'],
